"""Tests for the srt.io.systemHelpers module."""
import shutil
import subprocess
import pytest
from pathlib import Path
from unittest.mock import patch, MagicMock
from audio_visualizer.srt.io.systemHelpers import (
    ensure_parent_dir,
    which_or_none,
    ffmpeg_ok,
    ffprobe_ok,
...
class TestFfmpegOk:
    ...
    @patch('audio_visualizer.srt.io.systemHelpers.which_or_none')
...
class TestFfmpegVersion:
    ...
    @patch('audio_visualizer.srt.io.systemHelpers.ffmpeg_ok')
    ...
    @patch('audio_visualizer.srt.io.systemHelpers.ffmpeg_ok')
    @patch('audio_visualizer.srt.io.systemHelpers.run_cmd_text')
...
class TestFfprobeVersion:
    ...
    @patch('audio_visualizer.srt.io.systemHelpers.ffprobe_ok')
