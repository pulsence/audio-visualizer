#!/usr/bin/env python3
"""Tests for srt.io.scriptReader module."""
...
from audio_visualizer.srt.io.scriptReader import MAX_PROMPT_CHARS, read_docx


def test_read_docx_paragraphs_and_list_items():
    fixture = Path(__file__).parent / "fixtures" / "srt" / "script_reader" / "sample.docx"
