...
- **Test suite:** 1424 tests across all packages, including dedicated coverage for main-window shell behavior, settings/recipe gating, bundle normalization, correction/training workflows, Render Composition playback and FFmpeg command generation, caption/audio-input handling, waveform loading, and integration smoke tests.
