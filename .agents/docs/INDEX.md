...
- **Test suite:** 1436 tests across all packages, including dedicated coverage for main-window shell behavior, settings/recipe gating, bundle normalization, correction/training workflows, Render Composition playback and FFmpeg command generation, preview/export diagnostics surfacing, caption/audio-input handling, waveform loading, integration smoke tests, and workflow-recipe persistence.
